...
fetch(`${base}/complexSearch?apiKey=${key}&query=${query}`)
      .then( function (response){
             return response.json();
                    ...
                    document.getElementsByClassName("recipeTitle")[0].style.backgroundImage = `url(${image0})`;

                    document.getElementsByClassName("recipeTitle")[1].innerHTML = recipesArray.results[1].title;
                    document.getElementsByClassName("recipeTitle")[1].style.backgroundImage = `url(${image1})`;

                    document.getElementsByClassName("recipeTitle")[2].innerHTML = recipesArray.results[2].title;
                    document.getElementsByClassName("recipeTitle")[2].style.backgroundImage = `url(${image2})`;

                    document.getElementsByClassName("recipeTitle")[3].innerHTML = recipesArray.results[3].title;
                    document.getElementsByClassName("recipeTitle")[3].style.backgroundImage = `url(${image3})`;

                    document.getElementsByClassName("recipeTitle")[4].innerHTML = recipesArray.results[4].title;
                    document.getElementsByClassName("recipeTitle")[4].style.backgroundImage = `url(${image4})`;

                    document.getElementsByClassName("recipeTitle")[5].innerHTML = recipesArray.results[5].title;
                    document.getElementsByClassName("recipeTitle")[5].style.backgroundImage = `url(${image5})`;
          });
